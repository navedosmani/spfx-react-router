...
export interface IWebpackStatsObject extends webpack.Stats.ToJsonOutput {
}
...
export interface IWebpackChunk {
    ...
    id: string | number;
    initial: boolean;
    modules?: webpack.Stats.FnModules[];
    names: string[];
    origins?: Array<{
...
export interface IWebpackModule extends webpack.Stats.FnModules {
}
...
//# sourceMappingURL=CopyAssetsTask.d.ts.map