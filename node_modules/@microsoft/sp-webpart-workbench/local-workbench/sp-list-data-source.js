define("67c6ff5a-7666-4442-a8e9-55e57867bc44_0.1.0", ["@ms/sp-base-data-source"], function(__WEBPACK_EXTERNAL_MODULE__9iOe__) { return /******/ (function(modules) { // webpackBootstrap
/******/ 	// The module cache
...
var ListDataSource = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](ListDataSource, _super);
    ...
    ListDataSource.prototype.getListFromWeb = function (webAbsoluteUrl, listId, queryString) {
        return this.get(webAbsoluteUrl, "/_api/web/lists(guid'" + listId + "')", queryString, 'ListDataSource', 'getListFromWeb')
            .then(function (jsonData) {
            return jsonData;
        });
    };
    ...
    ListDataSource.prototype.getDefaultDocumentLibrary = function (webAbsoluteUrl, queryString) {
        return this.get(webAbsoluteUrl, '/_api/web/DefaultDocumentLibrary', queryString, 'ListDataSource', 'getDefaultDocumentLibrary')
            .then(function (jsonData) {
            return jsonData;
        });
    };
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _ListDataSource__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./ListDataSource */ "f/2W");
...
/******/ })});;
//# sourceMappingURL=sp-list-data-source.js.map